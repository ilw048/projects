...
| :---------------------- | :---------------------- | :---------------------- |
| [CV: определение возраста по фото](ComputerVision) | Выявление агрессивных комментариев для оптимизации работы модераторов. | *PyTorch, Sklearn, CatBoost, Pandas, Numpy* |
