...
| [Прогнозирование электропотребления](power_consumption_forecast) | Построение недельных прогнозов электропотребления в городе Выборг по реальным данным| *pandas, sklearn, keras, tensorflow, numpy, matplotlib* |
